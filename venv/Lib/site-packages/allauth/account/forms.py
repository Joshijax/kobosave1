...
class LoginForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'type': 'password', 'class':'form-control mb-4', 'placeholder':_('password'),}))
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    first_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'First Name', 'class':'form-control col-6' }), required=False)
    last_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'First Name', 'class':'form-control col-6' }), required=False)

    password = forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control mb-4', 'placeholder':'input your password' }), required=False)
...
class SignupForm(BaseSignupForm):
    password2 = forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control mb-4', 'placeholder':'input your password' }))
    def __init__(self, *args, **kwargs):
        super(SignupForm, self).__init__(*args, **kwargs)
        self.fields['password1'] = PasswordField(label=_("Password"), widget=forms.PasswordInput(attrs={'class':'form-control mb-4', 'placeholder':'input your password' }))
